...
const appMarkers = [
  'vm-bench__render',
  'vm-bench__render1000Items1',
  'vm-bench__clearItems1',
  'vm-bench__render1000Items2',
  'vm-bench__clearItems2',
  'vm-bench__render5000Items1',
  'vm-bench__clearManyItems1',
  'vm-bench__render5000Items2',
  'vm-bench__clearManyItems2',
  'vm-bench__render1000Items3',
  'vm-bench__append1000Items1',
  'vm-bench__append1000Items2',
  'vm-bench__updateEvery10thItem1',
  'vm-bench__updateEvery10thItem2',
  'vm-bench__selectFirstRow1',
  'vm-bench__selectSecondRow1',
  'vm-bench__removeFirstRow1',
  'vm-bench__removeSecondRow1',
  'vm-bench__swapRows1',
  'vm-bench__swapRows2',
  'vm-bench__clearItems4',
].reduce((acc, marker) => {
