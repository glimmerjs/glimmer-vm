...
export const VM_DUP_FP_OP = 33 satisfies VmDupFp;
...
export const VM_BIND_DYNAMIC_SCOPE_OP = 58 satisfies VmPushAndBindDynamicScope;
export const VM_PUSH_AND_BIND_DYNAMIC_SCOPE_OP = 59 satisfies VmPushDynamicScope;
...
export const VM_JIT_INVOKE_VIRTUAL_OP = 200 satisfies VmJitInvokeVirtual;
...
export const VM_RESOLVE_COMPONENT_DEFINITION_OR_STRING =
  80 satisfies VmResolveComponentDefinitionOrString;
export const VM_RESOLVE_COMPONENT_DEFINITION = 81 satisfies VmResolveComponentDefinition;
...
export const VM_HELPER_FRAME_OP = 93 satisfies VmHelperFrame;
...
export const VM_HELPER_OP = 101 satisfies VmHelper;
export const VM_PUSH_FRAME_WITH_RESERVED_OP = 102 satisfies VmPushFrameWithReserved;
...
export const VM_DUP_SP_OP = 113 satisfies VmDupSp;
export const VM_CONSTRUCT_ARGS_OP = 114 satisfies VmConstructArgs;
export const VM_PUSH_HELPER_OP = 115 satisfies VmPushHelper;
