...
export type VmStaticComponentAttr = 104;
export type VmDynamicContentType = 105;
export type VmDynamicHelper = 106;
export type VmDynamicModifier = 107;
export type VmIfInline = 108;
export type VmNot = 109;
export type VmGetDynamicVar = 110;
export type VmLog = 111;
export type VmSize = 112;
