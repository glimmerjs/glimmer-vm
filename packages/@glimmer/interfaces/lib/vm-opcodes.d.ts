...
export interface VmMachineOpMap {
  PushFrame: 0;
  PopFrame: 1;
  InvokeVirtual: 2;
  InvokeStatic: 3;
...
export type VmMachineOpName = keyof Omit<VmMachineOpMap, 'MachineSize'>;
export type VmMachineOp = VmMachineOpMap[VmMachineOpName];
...
export type VmOpName = keyof Omit<VmOpMap, 'Size'>;
export type VmOp = VmOpMap[VmOpName];
