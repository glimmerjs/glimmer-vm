...
export function canInsertIntoSVG(parent: HTMLElement, html: string, svgNameSpace: SVG_NAMESPACE): boolean {
  if (emptyHTML(html)) {
    return false;
  }
...
export function shouldFixSVG(document: Document, svgNamespace: SVG_NAMESPACE) {
