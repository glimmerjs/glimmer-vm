...
import { ReadonlyCapturedArguments, ReadonlyArguments } from '../vm/arguments';
...
export function isComponentDefinition(definition: any): definition is CurriedComponentDefinition {
  return definition && definition[CURRIED_COMPONENT_DEFINITION_BRAND];
}
...
export class CurriedComponentDefinition {
  ...
  constructor(
    ...
    protected args: Option<ReadonlyCapturedArguments>
  ) {}

  unwrap(args: ReadonlyArguments): ComponentDefinition {
...
export function curry(
  ...
  args: Option<ReadonlyCapturedArguments> = null
