...
import { BasicComponent, TestDynamicScope, TestEnvironment, TestModifierManager, assertNodeTagName, equalTokens, stripTight, trimLines } from '@glimmer/test-helpers';
...
module('[glimmer-runtime] Updating', hooks => {
  ...
  test('updating a curly with a safe and unsafe string', assert => {
    ...
    let safeString = {
      ...
      toHTML(this: SafeString) { return this.string; },
      toString(this: SafeString) { return this.string; }
    };
