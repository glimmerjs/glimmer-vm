...
// Statements
export const isFlushElement: Is<Statements.FlushElement> = is<Statements.FlushElement>(
...
// Expressions
export const isGet: Is<Expressions.GetSymbol> = is<Expressions.GetSymbol>(opcodes.GetSymbol);
