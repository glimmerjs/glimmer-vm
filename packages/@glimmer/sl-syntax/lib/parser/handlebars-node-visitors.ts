...
export abstract class HandlebarsNodeVisitors extends Parser {
  ...
  abstract createMustacheTag(mustache: ASTv1.MustacheStatement): void;
  abstract closeMustacheTag(mustache: ASTv1.MustacheStatement): void;
  ...
  Program(program: HBS.Program): ASTv1.Block | ASTv1.Template {
    ...
    if (l === 0) {
      ...
      return stack.pop() as ASTv1.Block | ASTv1.Template;
    }
