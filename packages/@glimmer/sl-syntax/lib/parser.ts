...
export abstract class Parser {
  ...
  protected inlineElementStack: Element[] = [];
  public inlineFlag = false;
  // 记录进入 inline 之前的 state
  public blockTokenizerState: TokenizerState = TokenizerState.beforeData;
  ...
  public currentNode: Option<
    ...
    >
  > = null;
  public blockCurrentNode: Option<
    Readonly<
      | ParserNodeBuilder<ASTv1.CommentStatement>
      | ASTv1.TextNode
      | ParserNodeBuilder<Tag<'StartTag'>>
