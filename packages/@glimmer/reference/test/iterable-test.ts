...
class Target implements IteratorSynchronizerDelegate {
  ...
  retain(key: string, item: BasicReference<Opaque>, _: BasicReference<Opaque>) {
  ...
  append(key: string, item: BasicReference<Opaque>, _: BasicReference<Opaque>) {
...
function initialize(arr: TestItem[]): { artifacts: IterationArtifacts, target: Target, reference: UpdatableReference<TestItem[]> } {
  ...
  let item: Option<IterationItem<Reference<Opaque>, Reference<Opaque>>>;
